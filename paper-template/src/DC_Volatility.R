...
# FOCUS COMPONENT: COMPONENT DC (Discussion of Character by Others) - HOTFIX 2.0
# ==============================================================================
...
#    - The script automatically processes Component DC and exports your prefixed PDFs.
# ==============================================================================
...
generate_component_analysis <- function(component_code, component_full_name, excel_path, desktop_dir) {
  ...
  # Isolate values and clear template spacers before building out missing coordinate steps
  timeline_base <- df %>%
