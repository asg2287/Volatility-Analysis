...
# FOCUS COMPONENT: COMPONENT DN (Description by Narrator) - HOTFIX 2.0
# ==============================================================================
...
#    - The script automatically processes Component DN and exports your prefixed PDFs.
# ==============================================================================
...
generate_component_analysis <- function(component_code, component_full_name, excel_path, desktop_dir) {
  ...
  # Isolate unique target column and break shared matrix defaults
  timeline_base <- df %>%
