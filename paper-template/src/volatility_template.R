...
#
# 3. COMPONENT SELECTION DIRECTION:
...
generate_component_analysis <- function(component_code, component_full_name, excel_path, desktop_dir) {
  ...
  # Process and aggregate scores safely, purging template empty-state artifacts
  timeline_base <- df %>%
...
# ==============================================================================
# 5. TARGETED COMPONENT RUNTIME INTERFACE (MANUAL EDIT REGION)
# ==============================================================================
# DIRECTIONS: Remove the leading '#' comment symbol from the SINGLE component 
...
# --- OPTION 3: CHARACTER NAME MENTIONS ---
# generate_component_analysis("N", "Character Name Mentions", excel_file_path, desktop_path)

# --- OPTION 4: PHYSICAL CHARACTER ACTIONS ---
# generate_component_analysis("A", "Physical Character Actions", excel_file_path, desktop_path)

# --- OPTION 5: DESCRIPTION BY NARRATOR ---
# generate_component_analysis("DN", "Description by Narrator", excel_file_path, desktop_path)

# --- OPTION 6: DIRECT CHARACTER COMMUNICATION ---
# generate_component_analysis("C", "Direct Character Communication", excel_file_path, desktop_path)
