...
# FOCUS COMPONENT: COMPONENT A (Physical Character Actions) - HOTFIX 2.0
# ==============================================================================
...
#    - The script automatically processes Component A and exports your PDFs.
# ==============================================================================
...
# 4. Corrected Processing Function --------------------------------------------
generate_component_analysis <- function(component_code, component_full_name, excel_path, desktop_dir) {
  ...
  # Isolate values and clear inactive spacer cells before completing grid
  timeline_base <- df %>%
...
message("Execution complete. 'A_Volatility' directory successfully compiled on Desktop.")
